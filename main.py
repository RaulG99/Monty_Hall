...
while(i<n):
    ...
    if(car == select):
        stay_wins+=1
        print("Iteration :",i," Selection:",select_door," Opening Door:",opening," Car is behind ",car_door," Stay wins")    
    else:
        switch_wins+=1
        print("Iteration :",i," Selection:",select_door," Opening Door:",opening," Car is behind ",car_door,"Switch wins")
